...
@PropsMixin()
abstract class ResizeSensorPropsMixin {    /* GENERATED CONSTANTS */ static const ConsumedProps $consumedProps = const ConsumedProps($props, $propKeys); static const PropDescriptor _$prop__onInitialize__ResizeSensorPropsMixin = const PropDescriptor(_$key__onInitialize__ResizeSensorPropsMixin), _$prop__onResize__ResizeSensorPropsMixin = const PropDescriptor(_$key__onResize__ResizeSensorPropsMixin), _$prop__isFlexChild__ResizeSensorPropsMixin = const PropDescriptor(_$key__isFlexChild__ResizeSensorPropsMixin), _$prop__isFlexContainer__ResizeSensorPropsMixin = const PropDescriptor(_$key__isFlexContainer__ResizeSensorPropsMixin), _$prop__shrink__ResizeSensorPropsMixin = const PropDescriptor(_$key__shrink__ResizeSensorPropsMixin), _$prop__quickMount__ResizeSensorPropsMixin = const PropDescriptor(_$key__quickMount__ResizeSensorPropsMixin); static const List<PropDescriptor> $props = const [_$prop__onInitialize__ResizeSensorPropsMixin, _$prop__onResize__ResizeSensorPropsMixin, _$prop__isFlexChild__ResizeSensorPropsMixin, _$prop__isFlexContainer__ResizeSensorPropsMixin, _$prop__shrink__ResizeSensorPropsMixin, _$prop__quickMount__ResizeSensorPropsMixin]; static const String _$key__onInitialize__ResizeSensorPropsMixin = 'ResizeSensorPropsMixin.onInitialize', _$key__onResize__ResizeSensorPropsMixin = 'ResizeSensorPropsMixin.onResize', _$key__isFlexChild__ResizeSensorPropsMixin = 'ResizeSensorPropsMixin.isFlexChild', _$key__isFlexContainer__ResizeSensorPropsMixin = 'ResizeSensorPropsMixin.isFlexContainer', _$key__shrink__ResizeSensorPropsMixin = 'ResizeSensorPropsMixin.shrink', _$key__quickMount__ResizeSensorPropsMixin = 'ResizeSensorPropsMixin.quickMount'; static const List<String> $propKeys = const [_$key__onInitialize__ResizeSensorPropsMixin, _$key__onResize__ResizeSensorPropsMixin, _$key__isFlexChild__ResizeSensorPropsMixin, _$key__isFlexContainer__ResizeSensorPropsMixin, _$key__shrink__ResizeSensorPropsMixin, _$key__quickMount__ResizeSensorPropsMixin]; 
  ...
  ResizeSensorHandler get onInitialize => props[_$key__onInitialize__ResizeSensorPropsMixin];  set onInitialize(ResizeSensorHandler value) => props[_$key__onInitialize__ResizeSensorPropsMixin] = value;

  /// A function invoked when the parent element is resized.
  ResizeSensorHandler get onResize => props[_$key__onResize__ResizeSensorPropsMixin];  set onResize(ResizeSensorHandler value) => props[_$key__onResize__ResizeSensorPropsMixin] = value;
  ...
  ///
  /// Default: false
  bool get isFlexChild => props[_$key__isFlexChild__ResizeSensorPropsMixin];  set isFlexChild(bool value) => props[_$key__isFlexChild__ResizeSensorPropsMixin] = value;

  /// Whether the [ResizeSensor] is a flex container. Necessary to apply the correct styling.
  ///
  /// Default: false
  bool get isFlexContainer => props[_$key__isFlexContainer__ResizeSensorPropsMixin];  set isFlexContainer(bool value) => props[_$key__isFlexContainer__ResizeSensorPropsMixin] = value;
  ...
  ///
  /// Default: false
  bool get shrink => props[_$key__shrink__ResizeSensorPropsMixin];  set shrink(bool value) => props[_$key__shrink__ResizeSensorPropsMixin] = value;
  ...
  ///
  /// Default: false
  bool get quickMount => props[_$key__quickMount__ResizeSensorPropsMixin];  set quickMount(bool value) => props[_$key__quickMount__ResizeSensorPropsMixin] = value;
}
...
@Component()
class ResizeSensorComponent extends UiComponent<ResizeSensorProps> with _SafeAnimationFrameMixin, _$ResizeSensorComponentImplMixin {   /* GENERATED IMPLEMENTATIONS */ @override typedPropsFactory(Map backingMap) => new _$ResizeSensorPropsImpl(backingMap) as dynamic; 
  // Refs
