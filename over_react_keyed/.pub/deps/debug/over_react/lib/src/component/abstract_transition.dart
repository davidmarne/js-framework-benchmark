...
@AbstractProps()
abstract class AbstractTransitionProps extends UiProps with TransitionPropsMixin {    /* GENERATED CONSTANTS */ static const ConsumedProps $consumedProps = const ConsumedProps($props, $propKeys); static const List<PropDescriptor> $props = const []; static const List<String> $propKeys = const []; }

@AbstractState()
abstract class AbstractTransitionState extends UiState {    /* GENERATED CONSTANTS */ static const StateDescriptor _$prop__transitionPhase__AbstractTransitionState = const StateDescriptor(_$key__transitionPhase__AbstractTransitionState); static const List<StateDescriptor> $state = const [_$prop__transitionPhase__AbstractTransitionState]; static const String _$key__transitionPhase__AbstractTransitionState = 'AbstractTransitionState.transitionPhase'; static const List<String> $stateKeys = const [_$key__transitionPhase__AbstractTransitionState]; 
  ...
  TransitionPhase get transitionPhase => state[_$key__transitionPhase__AbstractTransitionState];  set transitionPhase(TransitionPhase value) => state[_$key__transitionPhase__AbstractTransitionState] = value;
}
...
abstract class AbstractTransitionComponent<T extends AbstractTransitionProps,
  ...
  get consumedProps => const [
    AbstractTransitionProps.$consumedProps /* GENERATED from $Props usage */,
    TransitionPropsMixin.$consumedProps /* GENERATED from $Props usage */,
  ];
