...
abstract class CssClassPropsMixin {    /* GENERATED CONSTANTS */ static const ConsumedProps $consumedProps = const ConsumedProps($props, $propKeys); static const PropDescriptor _$prop__className__CssClassPropsMixin = const PropDescriptor(_$key__className__CssClassPropsMixin), _$prop__classNameBlacklist__CssClassPropsMixin = const PropDescriptor(_$key__classNameBlacklist__CssClassPropsMixin); static const List<PropDescriptor> $props = const [_$prop__className__CssClassPropsMixin, _$prop__classNameBlacklist__CssClassPropsMixin]; static const String _$key__className__CssClassPropsMixin = 'className', _$key__classNameBlacklist__CssClassPropsMixin = 'classNameBlacklist'; static const List<String> $propKeys = const [_$key__className__CssClassPropsMixin, _$key__classNameBlacklist__CssClassPropsMixin]; 
  Map get props;
  ...
  String get className => props[_$key__className__CssClassPropsMixin];  set className(String value) => props[_$key__className__CssClassPropsMixin] = value;
  ...
  /// [UiComponent.forwardingClassNameBuilder]).
  String get classNameBlacklist => props[_$key__classNameBlacklist__CssClassPropsMixin];  set classNameBlacklist(String value) => props[_$key__classNameBlacklist__CssClassPropsMixin] = value;
}
