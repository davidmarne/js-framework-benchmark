...
export let frameworks = [
    f("angular-dart-keyed", true),
    f("angular-dart-non-keyed", false),
    ...
    f("over_react_keyed", true),
    f("over_react_non-keyed", false),
    ...
    f("wui_builder-non-keyed", false),
    f("wui_builder-keyed", true),
]
